...
function AdviceShopping(){
    return(
        ...
        <h2 className='text-center mb-5 mt-5 text-white fw-bold fs-3' style={{textShadow:"2px 2px 8px black"}}>Explore Our Product Advantages</h2>
        <div className="row mb-5">
        <div className="mt-5 d-flex justify-content-around feature ">
            <div className="col-xl-3 col-lg-4 col-md-6 col-10 p-5 h-5 c-feature m-1 ">
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 col-10 p-5 c-feature m-1 ">
